defmodule SelectoDBDuckDB.WriteAdapterTest do
  ...
  setup do
    ...
    execute!(connection, "CREATE SEQUENCE item_ids START 1")
    ...
    execute!(connection, "CREATE SEQUENCE child_ids START 1")

    execute!(connection, """
    CREATE TABLE children (
      id BIGINT PRIMARY KEY DEFAULT nextval('child_ids'),
      tenant_id BIGINT NOT NULL,
  ...
  test "reports versioned truthful write capabilities", %{selecto: selecto} do
    ...
    refute capabilities.merge_parameter_binding
  ...
  test "executes a generated-key graph atomically through the ordered fallback", %{
    connection: connection,
    selecto: selecto
  } do
    root =
